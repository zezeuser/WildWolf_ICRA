                ...
                if (blackboard->info.strategy == "go_buff"){
                        ...
                        if (blackboard->info.remain_hp >= 400){
                                ...
                                if (blackboard->info.remain_bullet > 0){
                                        if ( (blackboard->info.shield_buff_active && blackboard->info.times_to_buff >0 
                                                ...
                                                // hp > 400 , remain_bullet > 0 , 队友和自身摄像头内无敌人 , 执行 搜索 行为
                                                ...
                                                // hp > 400 , remain_bullet > 0 , shield buff 已经获取 , 队友视野内有敌人 ， 执行前往支援行为
                                ...
                                // not enough bullet
                                        ...
                                        if (last_state == BehaviorStateEnum::SHIELD  && blackboard->info.shield_buff_active && blackboard->info.times_to_buff>0
