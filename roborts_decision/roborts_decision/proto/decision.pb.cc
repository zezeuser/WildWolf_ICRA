  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        ...
        if (input->ExpectTag(66)) goto parse_loop_auxe_bot;
        if (input->ExpectTag(74)) goto parse_loop_master_bot;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(90)) goto parse_loop_wait_point;
        input->UnsafeDecrementRecursionDepth();
...
::google::protobuf::uint8* DecisionConfig::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->auxe_bot_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        8, this->auxe_bot(i), false, target);
  }
  ...
  for (unsigned int i = 0, n = this->master_bot_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        9, this->master_bot(i), false, target);
  }
  ...
  for (unsigned int i = 0, n = this->wait_point_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        11, this->wait_point(i), false, target);
  }
