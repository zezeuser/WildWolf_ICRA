...
### TODO
    ...
    def reset(self):
        ...
        self.dev = False
        self.memory = []
        cars = np.array([[1, 50, 50, 0, 0, 0, 2000, 0, 0, 1, 5000, 4, 0, 0, 0, 0],
    ...
    def step(self, orders):
        car_orders = np.zeros((2,7))    #输入一个车的指令 ， 变成两台车的指令 ， 另一台车全为0 
        car_orders[0] = orders
        self.orders[0:self.car_num] = car_orders
        self.orders = car_orders
